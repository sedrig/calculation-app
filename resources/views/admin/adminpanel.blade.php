                        ...
                        <div class="ap__setting ap_mb">
                            ...
                            <form class="ap__form" method="POST" action="{{ route('family.store') }}">
                                ...
                                <div class="ap__row ap_mb">
                                    ...
                                    <div class="ap__group">
                                        <input id="catalog-name" class="ap__input" type="text" name="family" autocomplete="off">
                                        <div class="ap__text">
                        ...
                        <div class="ap__setting">
                            ...
                            <form class="ap__form" method="POST" action="{{ route('service.store') }}">
                                ...
                                <div class="ap__row ap_mb">
                                    ...
                                    <div class="ap__group">
                                        <input id="name-service" class="ap__input" name="services" type="text" autocomplete="off">
                                        <div class="ap__text">
                ...
                @else
                    <div class="ap__section">
                        @if ($identify === 1)
                            <div class="ap__setting ap_mb">
                                <div class="ap__title">Каталог</div>
                                <form class="ap__form" method="POST" action="{{ route('family.update', $families->id) }}">
                                    @csrf
                                    @method('PUT')
                                    <div class="ap__row ap_mb">
                                        <div class="ap__label">Назва каталогу</div>
                        ...
                        @elseif($identify===3)
                            <div class="ap__setting">
                                ...
                                <form class="ap__form" method="POST" action="{{ route('service.update', $service->id) }}">
                                    @csrf
                                    @method('PUT')
                                    <div class="ap__row ap_mb">
                                        <div class="ap__label">Тип сервісу</div>
                                    ...
                                    <div class="ap__row ap_mb">
                                        <div class="ap__label">Ціна сервісу</div>
                                        <div class="ap__group">
                                            <input id="price-service" class="ap__input" type="text" autocomplete="off" name="price"
                                                value="{{ $service->price }}">
                                            <div class="ap__text">
                                                Введіть ціну сервісу
                                            </div>
